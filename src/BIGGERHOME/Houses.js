...
const Houses = () => {
  ...
  const navigate = useNavigate();
    ...
    useEffect(()=>{
      axios.post("http://localhost:8000/properties/onevalue",{
        objectid
      }).then((res)=>{
    ...
    const handleBookButtonClick = () => {
      ...
      axios.post("http://localhost:8000/Properties/datevalue",{
...
setalerts("Give card number as 4242 4242 4242 4242")
  ...
  useEffect(()=>{
    ...
    axios.post("http://localhost:8000/Properties/payment",{tokenId:stripetoken.id,
